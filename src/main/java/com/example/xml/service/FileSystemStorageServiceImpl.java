...
public class FileSystemStorageServiceImpl implements StorageService {
    ...
    @Autowired
    public FileSystemStorageServiceImpl(@Value("${storage.location}") String location) {
    ...
    public Path store(MultipartFile file) {
        ...
        try {
            Path pathFile = this.rootLocation.resolve(Paths.get(file.getOriginalFilename()));
            Path destinationFile = pathFile
                    .normalize()
                    .toAbsolutePath();
